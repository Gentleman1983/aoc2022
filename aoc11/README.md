...
of the items from your pack goes flying overhead. Monkeys are playing 
...
- `Starting items` lists your **worry level** for each item the monkey is currently holding in the order they will 
be inspected.
